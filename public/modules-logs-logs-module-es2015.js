...
/* harmony import */ var _logs_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logs.component */ "./src/app/modules/logs/logs.component.ts");
...
LogsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function LogsRoutingModule_Factory(t) { return new (t || LogsRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
...
function LogsComponent_app_page_loading_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-page-loading");
} }
function LogsComponent_div_1_div_9_clr_dg_row_10_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function () { return [100, 200, 500, 1000]; };
function LogsComponent_div_1_div_9_Template(rf, ctx) { if (rf & 1) {
...
class LogsComponent {
    ...
    ngOnInit() {
        this.logs$ = this.dataService.records$('syslog', {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((l) => l.data));
        this.logs$.subscribe(() => {
            this.loading = false;
        });
    }
}
LogsComponent.ɵfac = function LogsComponent_Factory(t) { return new (t || LogsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"])); };
LogsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LogsComponent, selectors: [["app-logs"]], decls: 2, vars: 2, consts: [[4, "ngIf"], ["class", "module-content-container", 4, "ngIf"], [1, "module-content-container"], [1, "module-header-wrapper", 2, "border-bottom", "1px solid #cccccc"], [1, "flex-container", 2, "padding", "15px"], [1, "module-branding"], [1, "module-brand"], ["shape", "book", 1, "is-solid", 2, "margin-right", "10px"], [1, "module-title"], [1, "module-nav", 2, "margin-left", "25px"], ["class", "module-content-area", "style", "padding: 10px;", 4, "ngIf"], [1, "module-content-area", 2, "padding", "10px"], [2, "width", "100px", 3, "clrDgField"], [2, "width", "150px", 3, "clrDgField"], [3, "clrDgField"], [4, "clrDgItems", "clrDgItemsOf"], [3, "clrDgPageSize"], ["pagination", ""], [3, "clrPageSizeOptions"]], template: function LogsComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _logs_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logs-routing.module */ "./src/app/modules/logs/logs-routing.module.ts");
/* harmony import */ var _logs_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./logs.component */ "./src/app/modules/logs/logs.component.ts");
...
//# sourceMappingURL=modules-logs-logs-module-es2015.js.map