...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 27, vars: 4, consts: [[1, "login-wrapper"], [1, "login"], [1, "title"], [1, "application-name"], [1, "login-group"], [1, "clr-sr-only"], ["clrSelect", "", "name", "type", 3, "ngModel", "ngModelChange"], ["value", "local"], ["value", "ldap"], ["type", "text", "name", "email", "clrInput", "", "placeholder", "email", 3, "ngModel", "ngModelChange"], ["type", "password", "name", "password", "clrPassword", "", "placeholder", "Password", 3, "ngModel", "ngModelChange"], ["class", "error active", 4, "ngIf"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"], ["href", "https://maestrostack.github.io", "target", "_blank", 1, "signup"], [1, "error", "active"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginComponent_Template_select_ngModelChange_9_listener($event) { return ctx.creds.strategy = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginComponent_Template_input_ngModelChange_17_listener($event) { return ctx.creds.email = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
