...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-stacks-stacks-module"], {
  ...
  /***/
  function srcAppModulesStacksStackDetailsStackDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StackDetailsComponent", function () {
    ...
    var _shared_page_loading_page_loading_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../shared/page-loading/page-loading.component */
    "./src/app/modules/shared/page-loading/page-loading.component.ts");

    function StackDetailsComponent_div_0_div_3_div_1_clr_timeline_step_9_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StackDetailsComponent_div_0_div_3_div_1_clr_timeline_step_9_Template_button_click_9_listener() {
          ...
          return ctx_r8.showNodeDetails(n_r7);
        });
    ...
    function StackDetailsComponent_div_0_div_3_div_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var nodes_r5 = ctx.ngIf;

        var item_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).ngIf;
    ...
    function StackDetailsComponent_div_0_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StackDetailsComponent_div_0_div_4_app_page_loading_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-page-loading");
      }
    }

    function StackDetailsComponent_div_0_div_4_div_2_pre_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StackDetailsComponent_div_0_div_4_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StackDetailsComponent_div_0_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);
    ...
    function StackDetailsComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StackDetailsComponent = /*#__PURE__*/function () {
      function StackDetailsComponent(dataService, activatedRoute) {
        _classCallCheck(this, StackDetailsComponent);
      ...
      _createClass(StackDetailsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.activatedRoute.params.subscribe(function (p) {
            _this.stackId = p.stack;

            _this.loadStackNodes();

            _this.item$ = _this.dataService.record$('api/stacks', p.stack);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StackDetailsComponent, [{
  ...
  /***/
  function srcAppModulesStacksStacksBrowseStacksBrowseComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StacksBrowseComponent", function () {
      return StacksBrowseComponent;
    });
    /* harmony import */
    ...
    function StacksBrowseComponent_app_page_loading_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-page-loading");
      }
    }

    function StacksBrowseComponent_div_1_div_2_div_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StacksBrowseComponent_div_1_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);
    ...
    function StacksBrowseComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StacksBrowseComponent = /*#__PURE__*/function () {
      function StacksBrowseComponent(authService, dataService) {
        _classCallCheck(this, StacksBrowseComponent);
      ...
      _createClass(StacksBrowseComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
    ...
    StacksBrowseComponent.ɵfac = function StacksBrowseComponent_Factory(t) {
      return new (t || StacksBrowseComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]));
    };

    StacksBrowseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: StacksBrowseComponent,
      selectors: [["app-stacks-browse"]],
      decls: 2,
      vars: 2,
      consts: [[4, "ngIf"], ["class", "catalog-browse-container", 4, "ngIf"], [1, "catalog-browse-container"], [1, "catalog-browse-menu"], ["class", "catalog-items-container", 4, "ngIf"], [1, "catalog-items-container"], [1, "catalog-items"], [1, "clr-row"], [1, "clr-col"], ["role", "alert", 1, "alert", "alert-info"], [1, "alert-items"], [1, "alert-item", "static"], [1, "alert-icon-wrapper"], ["shape", "info-circle", 1, "alert-icon"], [1, "alert-text"], [1, "clr-row", "items-row"], ["class", "clr-col-lg-3 clr-col-md-6 clr-col-12", 4, "ngFor", "ngForOf"], [1, "clr-col-lg-3", "clr-col-md-6", "clr-col-12"], [1, "card", "item-card", "clickable", 3, "routerLink"], [1, "card-block"], [1, "card-title"], [1, "card-text"]],
      template: function StacksBrowseComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StacksBrowseComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesStacksStacksRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StacksRoutingModule", function () {
      return StacksRoutingModule;
    });
    /* harmony import */
    ...
    var _stacks_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./stacks.component */
    "./src/app/modules/stacks/stacks.component.ts");
    /* harmony import */


    var _stacks_browse_stacks_browse_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./stacks-browse/stacks-browse.component */
    "./src/app/modules/stacks/stacks-browse/stacks-browse.component.ts");
    /* harmony import */


    var _stack_details_stack_details_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./stack-details/stack-details.component */
    "./src/app/modules/stacks/stack-details/stack-details.component.ts");
    ...
    var StacksRoutingModule = function StacksRoutingModule() {
      _classCallCheck(this, StacksRoutingModule);
    };

    StacksRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: StacksRoutingModule
    });
    StacksRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function StacksRoutingModule_Factory(t) {
        return new (t || StacksRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](StacksRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StacksRoutingModule, [{
  ...
  /***/
  function srcAppModulesStacksStacksComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StacksComponent", function () {
    ...
    function StacksComponent_app_page_loading_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-page-loading");
      }
    }

    function StacksComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 2);
    ...
    var StacksComponent = /*#__PURE__*/function () {
      function StacksComponent(authService, dataService) {
        _classCallCheck(this, StacksComponent);
    ...
    StacksComponent.ɵfac = function StacksComponent_Factory(t) {
      return new (t || StacksComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]));
    };

    StacksComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: StacksComponent,
      selectors: [["app-stacks"]],
      decls: 2,
      vars: 2,
      consts: [[4, "ngIf"], ["class", "module-content-container", 4, "ngIf"], [1, "module-content-container"], [1, "module-header-wrapper", 2, "border-bottom", "1px solid #cccccc"], [1, "flex-container", 2, "padding", "15px"], [1, "module-branding"], [1, "module-brand"], ["shape", "layers", 1, "is-solid", 2, "margin-right", "10px"], [1, "module-title"], [1, "module-nav", 2, "margin-left", "25px"], [1, "module-content-area", 2, "padding", "10px"]],
      template: function StacksComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _shared_page_loading_page_loading_component__WEBPACK_IMPORTED_MODULE_4__["PageLoadingComponent"], _clr_angular__WEBPACK_IMPORTED_MODULE_5__["ClrIconCustomTag"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterOutlet"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StacksComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
          selector: 'app-stacks',
  ...
  /***/
  function srcAppModulesStacksStacksModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StacksModule", function () {
      return StacksModule;
    });
    /* harmony import */
    ...
    var _stacks_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./stacks-routing.module */
    "./src/app/modules/stacks/stacks-routing.module.ts");
    /* harmony import */


    var _stacks_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./stacks.component */
    "./src/app/modules/stacks/stacks.component.ts");
    /* harmony import */
    ...
    var _stacks_browse_stacks_browse_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./stacks-browse/stacks-browse.component */
    "./src/app/modules/stacks/stacks-browse/stacks-browse.component.ts");
    /* harmony import */


    var _stack_details_stack_details_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./stack-details/stack-details.component */
    "./src/app/modules/stacks/stack-details/stack-details.component.ts");

    var StacksModule = function StacksModule() {
      _classCallCheck(this, StacksModule);
    };

    StacksModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: StacksModule
    });
    StacksModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function StacksModule_Factory(t) {
        return new (t || StacksModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _clr_angular__WEBPACK_IMPORTED_MODULE_5__["ClarityModule"], _stacks_routing_module__WEBPACK_IMPORTED_MODULE_2__["StacksRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](StacksModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StacksModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_stacks_component__WEBPACK_IMPORTED_MODULE_3__["StacksComponent"], _stacks_browse_stacks_browse_component__WEBPACK_IMPORTED_MODULE_6__["StacksBrowseComponent"], _stack_details_stack_details_component__WEBPACK_IMPORTED_MODULE_7__["StackDetailsComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _clr_angular__WEBPACK_IMPORTED_MODULE_5__["ClarityModule"], _stacks_routing_module__WEBPACK_IMPORTED_MODULE_2__["StacksRoutingModule"]]
...
//# sourceMappingURL=modules-stacks-stacks-module-es5.js.map